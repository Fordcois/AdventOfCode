...
commands = [int(x) for x in numbers[3:]]
...
def solve():
    ...
    starting_number = 117440

    
    computer['A'] = starting_number
    output=[]
    while instruction_pointer < len(commands):
        ...
        if out != None:
            output.append(out)
    print(f'Computer A was started with {starting_number}')
    print (f'Programs:  {commands}')
    print (f'Output:    {output}')
    if commands == output:
        print('\033[1;32mMATCH!\033[0m')
